  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">78.07% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>89/114</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L379'></a><a href='#L379'>379</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  static defaultProps = {
    ...
    interval:    60000,
    filter:      (d) =&gt; { return d; },
    onChange:    <span class="fstat-no" title="function not covered" >()</span> =&gt; {}
  };
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (prevProps.interval !== interval) {
...
&nbsp;
   ...
   */
  getTitle = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
    const { titleFormat } = <span class="cstat-no" title="statement not covered" >this.props;</span>
&nbsp;
    const datetime = <span class="cstat-no" title="statement not covered" >Moment.getDatetime(this.props);</span>
    const format = <span class="cstat-no" title="statement not covered" >titleFormat || Moment.globalFormat;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return datetime.format(format);</span>
  };
&nbsp;
&nbsp;
  /**
...
&nbsp;
   ...
   * @param {*} props
   */
<span class="fstat-no" title="function not covered" >  up</span>date(props) {
    const { onChange } = <span class="cstat-no" title="statement not covered" >props;</span>
    const content = <span class="cstat-no" title="statement not covered" >Moment.getContent(props);</span>
<span class="cstat-no" title="statement not covered" >    this.setState({ content }, <span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      onChange(content);</span>
    });
  }
&nbsp;
  /**
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (withTitle) {
<span class="cstat-no" title="statement not covered" >      props.title = this.getTitle();</span>
    }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Oct 04 2019 09:40:42 GMT-0400 (EDT)
</div>
</div>
